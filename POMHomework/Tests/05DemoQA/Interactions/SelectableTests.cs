...
namespace POMHomework.Tests._05DemoQA.Interactions
{
    ...
    public class SelectableTests : BaseTest
    {
        ...
        {
            //Arrange
            string colorBefore = _selectablePage.LastBox.GetCssValue("background-color");

            //Act
            _selectablePage.LastBox.Click();
            string colorAfter = _selectablePage.LastBox.GetCssValue("background-color");
        ...
        public void SelectItemColorChange_When_SelectItem([Range(0, 3)] int index)
        {
           //Arrange
            ...
            //Act
            string listColor = _selectablePage.ListOptions[index].GetCssValue("background-color");
